      ...
      * Author:
      * Date:
      * Purpose:VAMOS A GUARDAR CIERTOS DATOS EN UN ARCHIVO . Explicacion del FI
      * Tectonics: cobc
      ******************************************************************
...
********************************************************************************
      ...
      *     + random: se accede de manera directa, sin tener que pasar por los o
...
********************************************************************************
      ...
      *tipos de OPEN:
      *  I-O abre archivo lectura-escritura
      *  INPUT abre archivo en modo lectura
      *  OUTPUT solo escritura (bueno para impresoras)
      *  EXTEND en archv. secuenciales, graba nueva informacion al final
      * (se puede usar EXCLUSIVE para bloquear el archivo cuando está en uso)
      * (se usar WITH LOCK  para archivos de cinta, que rebobinan)
      ...
      * a partir de 8, todos son errores (ver listado codigos error)
